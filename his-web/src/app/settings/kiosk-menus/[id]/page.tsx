// =============================================================================
// File: src/app/settings/kiosk-menus/[id]/page.tsx
// Description: Edit Kiosk Menu - Form with CustomSelect lookups
// =============================================================================
...
import { ArrowLeft, Save, Trash2, Monitor, Eye } from 'lucide-react';
...
export default function EditKioskMenuPage() {
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Edit Kiosk Menu</h1>
              <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">แก้ไขเมนู: {formData.button_caption}</p>
            </div>
          </div>
          <button
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white dark:bg-slate-900 rounded-2xl shadow-2xl w-full max-w-md p-6">
            ...
            <p className="text-slate-600 dark:text-slate-400 mb-6">
              Are you sure you want to delete <strong>{formData.button_caption}</strong>? This action cannot be undone.
            </p>
            <div className="flex items-center justify-end gap-3">
